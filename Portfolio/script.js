document.addEventListener("DOMContentLoaded", () => {
    ...
    const projectDetails = {
        "taskmaster-pro": {
            title: "TaskMaster Pro - Project Management Application",
            date: "",
            description: `
                <p>Developed a comprehensive project management application to enhance team collaboration and task management efficiency. Key features include user authentication, task assignment, commenting, and task status tracking.</p>
                <p><strong>Tech Stack:</strong> React, Node.js, Express, MongoDB, JWT, CSS</p>
            `
        },
        "cloud-native": {
        ...
        "portfolio": {
            ...
            date: "",
            description: `
                <p>Designed and developed a personal portfolio website to showcase my skills, projects, and experience. The website features a responsive design, interactive sections for projects and certifications, and a contact form integrated with EmailJS for seamless communication.</p>
